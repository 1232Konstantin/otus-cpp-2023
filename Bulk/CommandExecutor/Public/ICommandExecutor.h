...
namespace Bulk
{
  ...
  protected:
    ...
    class ICommandExecutor& CommandExecutor;
  ...
  protected:
     ...
     */
    explicit ICommandExecutor(const size_t& inBulkSize, std::shared_ptr<ICommandLogger> inLogger)
      : BulkSize(inBulkSize)
      , Logger(inLogger)
    {}
  ...
  public:
    ...
    virtual bool AddCommand_Normal(std::shared_ptr<ICommand> Command) = 0;
    virtual bool AddCommand_Dynamic(std::shared_ptr<ICommand> Command) = 0;

    /**
     * @breif Logic to be triggered on EOF
     */
    virtual bool OnEOF() = 0;
    virtual bool OnEOF_Normal() = 0;
    virtual bool OnEOF_Dynamic() = 0;
